...
from model_api import ApiTutor, HttpTransport, ModelAPIError, ModelConfig, api_key_variable, load_model_config
...
SOURCES = ('prompts/protocol.txt', 'prompts/baseline.txt', 'prompts/output_contract.txt', 'reading_check.py', 'probe_model.py', 'core.py', 'curriculum.py', 'step_check.py', 'workflow.py',
            'retrieval.py', 'model_boundary.py', 'teaching_guard.py', 'model_api.py', 'http_worker.py',
           'http_test_support.py', 'examples/model_reply.json')
REVIEW_ITEMS = {
