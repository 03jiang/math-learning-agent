...
from core import TutorReply, ValidationError
from curriculum import MockTutor
from http_worker import MAX_REQUEST_BYTES, OPENAI_ENDPOINT, endpoint_kind
from model_boundary import (build_model_request, parse_model_response,
...
class HttpTransport:
    ...
    def send(self, payload, key, timeout_seconds, record):
        ...
        try:
            process = subprocess.run([sys.executable, str(ROOT / 'http_worker.py')],
