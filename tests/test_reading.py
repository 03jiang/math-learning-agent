...
from legacy.curriculum import QUESTIONS
from legacy.reading_check import READING_TASKS, check_reading, reading_questions
...
class ReadingAppTests(unittest.TestCase):
    def setUp(self):
        ...
        self.config.write_text((APP.parent.parent / 'model_config.example.json').read_text())
