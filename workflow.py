...
from core import (LearningAssistant, LearningSettings, Metadata, PendingUpdate, SETTING_OPTIONS,
                  STATE_FIELDS, SimulatedReply, Snapshot, TaskState, ValidationError, validate_patch)
from retrieval import NOTES_DIR, ToolBudget, check_deadline

from curriculum import TASKS, MockTutor, assess_submission, initial_snapshot
from model_boundary import reading_context
