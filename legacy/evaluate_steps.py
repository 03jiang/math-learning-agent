...
from legacy.curriculum import check_solution

ROOT = Path(__file__).resolve().parents[1]
SOURCES = ['legacy/core.py', 'legacy/curriculum.py', 'legacy/step_check.py', 'legacy/workflow.py', 'legacy/retrieval.py', 'app.py',
           'legacy/model_boundary.py', 'legacy/model_api.py', 'legacy/http_worker.py', 'legacy/run_app.py', 'legacy/evaluate_steps.py',
           'legacy/reading_check.py', 'legacy/reading_ui.py']
