...
from core import SETTING_OPTIONS, ValidationError
from workflow import TASKS, Workspace
from curriculum import QUESTIONS, OPERANDS
from model_api import configured_tutor
from reading_ui import render_reading_card

st.set_page_config(page_title='数学学习助手', page_icon='🌱', layout='wide')
DATA_DIR = Path(os.environ.get('MATH_ASSISTANT_DATA_DIR', Path(__file__).resolve().parent / 'data' / 'math'))
